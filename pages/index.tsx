...
const Home: NextPage = () => {
  return (
    <div className="flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      <Head>
        <title>Para restaurar caras guacho</title>
      </Head>
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-28 mt-20">
        ...
        >
          Usado supuestamente por <span className="font-semibold">200,000</span> locos
          felices
        </a>
        ...
        <p className="mx-auto mt-12 max-w-xl text-lg text-slate-700 leading-7">
          Fotos antiguas y borrosas? Deja que la IA las restaure para que esas
          memorias vivan algo más. Gratis por el momento.
        </p>
