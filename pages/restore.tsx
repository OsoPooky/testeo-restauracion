...
const options = {
  ...
  onValidate: async (file: File): Promise<undefined | string> => {
    ...
    return isSafe
      ? undefined
      : "La conchua tuya, no se puede restaurar imágenes en pelotas... virgo.";
  },
};
